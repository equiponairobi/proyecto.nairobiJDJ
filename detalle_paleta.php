		...
		<div id="fh5co-main">
			...
			<div class="fh5co-narrow-content animate-box" data-animate-effect="fadeInLeft">
                ...
                <div class="fh5co-text">
                                <h1>DETALLE  PALETA DE SOMBRAS</h1>
				<p> Paleta de sombras con nueve tonos enroquecidas con polvo de cocoa en distintos tonos brillates y mates. <br> 
Variedad de colores, encuentra el que mas te guste </p>
